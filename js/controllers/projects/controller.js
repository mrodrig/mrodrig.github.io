    ...
    $scope.projects = [
        {
            ...
            list:  [
                ...
                },
                {
                    ...
                    html: '<img src="https://img.shields.io/npm/v/json-2-csv.svg" style="margin-bottom: 0em; padding-left: 5px;"/><img src="https://img.shields.io/npm/dm/json-2-csv.svg" style="margin-bottom: 0em; padding-left: 5px;"/>'
                },
                {
                    ...
                    html: '<img src="https://img.shields.io/npm/v/tag-cloud.svg" style="margin-bottom: 0em; padding-left: 5px;"/><img src="https://img.shields.io/npm/dm/tag-cloud.svg" style="margin-bottom: 0em; padding-left: 5px;"/>'
                },
                {
                    ...
                    html: '<img src="https://img.shields.io/npm/v/memo-cache.svg" style="margin-bottom: 0em; padding-left: 5px;"/><img src="https://img.shields.io/npm/dm/memo-cache.svg" style="margin-bottom: 0em; padding-left: 5px;"/>'
                },
                {
                    ...
                    html: '<img src="https://img.shields.io/npm/v/api-generator.svg" style="margin-bottom: 0em; padding-left: 5px;"/><img src="https://img.shields.io/npm/dm/api-generator.svg" style="margin-bottom: 0em; padding-left: 5px;"/>'
                },
                {
                    ...
                    html: '<img src="https://img.shields.io/npm/v/doc-path.svg" style="margin-bottom: 0em; padding-left: 5px;"/><img src="https://img.shields.io/npm/dm/doc-path.svg" style="margin-bottom: 0em; padding-left: 5px;"/>'
                },
                {
                    ...
                    html: '<img src="https://img.shields.io/npm/v/updep.svg" style="margin-bottom: 0em; padding-left: 5px;"/><img src="https://img.shields.io/npm/dm/updep.svg" style="margin-bottom: 0em; padding-left: 5px;"/>'
                },
                {
                    name: 'Node Module: htpasswd-mgr',
                    date: 'October 2018 - Present',
                    desc: 'In order to automate the process of managing users for the Admin portion of the signaturelimocompany.com website project, I created this node module which allows for the programmatic manipulation of an .htpasswd file.',
                    url : 'https://github.com/mrodrig/htpasswd-mgr',
                    html: '<img src="https://img.shields.io/npm/v/htpasswd-mgr.svg" style="margin-bottom: 0em; padding-left: 5px;"/><img src="https://img.shields.io/npm/dm/htpasswd-mgr.svg" style="margin-bottom: 0em; padding-left: 5px;"/>'
                }
            ]
        },
        {
            ...
            list:  [
                {
                    ...
                    url:  'https://is3500termproject.wiki.zoho.com'
                },
                {
                ...
                },
                {
                    ...
                    url:  'https://github.com/mrodrig/cs4800'
                },
                {
