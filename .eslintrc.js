module.exports = {
    ...
    rules: {
        ...
        'vue/component-definition-name-casing': ['error', 'PascalCase'], // enforce specific casing for the name property in Vue components (AboutMe over aboutMe and about-me)
